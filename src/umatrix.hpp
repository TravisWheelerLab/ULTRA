/*
 ...
 UMatrix contains two seperate matrix spaces:
    ...
    an int based transition matrix used to store transitions
        ...
        instead it only describes transitions from CT_BACKGROUND cells and CT_MATCH
        this allows for some memory saving
...
public:
    ...
    void        AdjustScoreToZero   (int    startingAt,
                                     int    numberOfColumns);
    ...
    int         *ForwardTraceback   (int    *traceArray,
                                     int    windowLength,
                                     int    row);
